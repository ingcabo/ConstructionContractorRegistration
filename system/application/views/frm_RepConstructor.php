...
<?php echo form_open('con_RepConstructor/gen_reporte');
$opc_dd = 'style="width:250px"';
?>
<table width="800" border="0" cellpadding="0" cellspacing="0" class="table_usuarios">
  ...
  <tr>
    ...
    $js = 'id="dpd_estado"  style="width:250px;" onchange="'.$xajax['content_mun'].'"';
  ...
  <tr>
    ...
    <td></td>
    <td colspan="4" valign="top"><div id="Divdpdmun"><select name="dpd_municipio" id="dpd_municipio" onchange="<?=$xajax['content_ciu'];?>" style="width:250px">
<option value="0">Seleccione uno</option>
  ...
  <tr>
    ...
    <td></td>
    <td colspan="4" valign="top"><div id="Divdpdciu"><select name="dpd_ciudades" id="dpd_ciudades" style="width:250px">
<option value="0">Seleccione uno</option>
</select></div></td>
    <td></td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td></td>
    <td colspan="4" valign="top"><?php echo form_dropdown('dpd_dencom',$dencom,'',$opc_dd); ?>    </td>
    <td></td>
    <td>&nbsp;</td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td></td>
    <td colspan="4" valign="top"><?php echo form_dropdown('dpd_nivfin',$nivfin,'',$opc_dd); ?></td>
    <td></td>
    <td>&nbsp;</td>
    </tr>
  <tr>
    ...
    <td></td>
    <td colspan="4" valign="top"><?php $opc = 'id="dpd_conpor" multiple="multiple" size="5" style="width:250px"'; echo form_dropdown('dpd_conpor[]',$conpor,'',$opc); ?></td>
    <td></td>
    <td>&nbsp;</td>
    </tr>
  <tr>
    ...
    <td></td>
    <td colspan="4" valign="top"><?php echo form_dropdown('dpd_anocon',$anocon,'',$opc_dd); ?></td>
    <td></td>
    <td>&nbsp;</td>
    </tr>
  <tr>
    ...
    <td></td>
    <td colspan="4" valign="top"><?php echo form_dropdown('dpd_tipemp',$tipemp,'',$opc_dd); ?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    </tr>
  <tr>
    ...
    <td></td>
    <td colspan="4" valign="top"><?php echo form_dropdown('dpd_anoreg',$anoreg,'',$opc_dd); ?></td>
    <td></td>
    <td>&nbsp;</td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3" align="center"  valign="top"><input  name="bto_procesar" type="submit" id="bto_procesar" value="Visualizar" />
    <input name="bto_imprimir"  type="submit" id="bto_imprimir" value="Imprimir" /></td>
    <td></td>
    <td>&nbsp;</td>
    <td></td>
    <td></td>
