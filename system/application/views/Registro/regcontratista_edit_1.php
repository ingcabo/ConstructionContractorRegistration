  ...
  <tr>
	...
	<?php
		  ...
		  <?php $consulta_tp = $this->db->query('select * from numeros_telefonicos_tipo order by ntt_numeros_telefonicos_tipo_pk') ?>
		   ...
		   <td colspan="2"> </td>
		   <td width="56">  </td>
		   <td width="282"><span class="fontnormal"><font color="#FF0000"> <?php echo form_error('num_'.$row2->ntt_numeros_telefonicos_tipo_pk); ?> </font></span> </td>
		   <td width="24">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		   <td width="30">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		   <?php echo "</tr>"; ?>
           <?php endforeach; ?>  
...
<table width="479px"> 
  ...
  <tr>
    ...
    <td><input type="text" name="codpost" maxlength="12" size="8" value="<?php echo $codpost; ?>" onkeypress="return SoloNumero(event)" />    </td><td><font color="#FF0000"><?php echo form_error('codpost'); ?></font></td>
  </tr>
  <tr>
    <td height="30"><label>Dirección Actual: </label></td>
    <td><font color="#FF0000"><?php echo form_error('dirfis'); ?></font></td>
  </tr>
  <tr>
