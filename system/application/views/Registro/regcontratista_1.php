...
<!--    Tabla hidden -->  
  ...
  <tr>
    ...
    <table width="799" height="26">
      <tr> 
        <td width="250" class="bgtitle"><label><b>Números Contacto</b></label></td>
      <tr><td height="20"></td><td width="45"></td>
	  <td></td>
      </tr>
        </tr>
		 <?php     
	...
	<?php     
		   ...
		   <td colspan="2"> </td>
		   <td width="115">  </td>
		   <td width="311"><span class="fontnormal"><font color="#FF0000"> <?php echo form_error('num_'.$row2->ntt_numeros_telefonicos_tipo_pk); ?> </font></span> </td>
		   <td width="24">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		   <td width="26">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		   <?php echo "</tr>"; ?>
           <?php endforeach; ?>  
