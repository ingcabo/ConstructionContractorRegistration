...
<table width="1000" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="700" valign="middle"><div align="center" class="style1">REPÚBLICA BOLIVARIANA DE VENEZUELA<br />
...
<br /><table width="1000" border="0" cellpadding="0" cellspacing="0" style="border:#666666 solid 1px;" class="tableborder">
  <!--DWLayoutTable-->
  <tr>
    ...
    <tr>
    <th width="100" height="30"  bgcolor="#466FD5" class="style1 style2 Estilo1">Nº Inscripción</th>
    ...
    <th width="65" valign="top"  bgcolor="#466FD5"  class="style1 style2 Estilo1">Calificación Financiera</th>
    <th width="100" valign="top"   bgcolor="#466FD5"  class="style1 style2 Estilo1">Capacidad Financiera</th>
    <th width="70" valign="top"   bgcolor="#466FD5"  class="style1 style2 Estilo1">Nivel  Contratación</th>
    <?php if(!$pdf) {?>
    <th width="170" align="center" valign="middle"  bgcolor="#466FD5" class="style1 style2 Estilo1">Dirección</th>
    <?php }?>
   ...
   ?>
    <tr>
      ...
      <td align="center" valign="top"   class="style1 style2 Estilo1 Estilo2"><?php if(trim($fila['ett_nombre']) <> 'Registrada') {echo $fila['ett_nombre'];}else{ echo anchor('con_reportes/rep_inscripcion/'.$fila['con_contratistas_pk'],$fila['ett_nombre']);}?></td>
      <td align="center" valign="top"  class="style1 style2 Estilo1 Estilo2"><?=$fila['nfs_nivel'];?></td>
      <td align="center" valign="top"  class="style1 style2 Estilo1 Estilo2"><?=number_format($fila['con_capacidad_financiera'],2,',','.');?></td>
