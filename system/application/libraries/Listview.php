...
//      if($CI->centinela->getReferencia() == '' or $CI->centinela->getReferencia() <> $CI->uri->segment(1) or $CI->centinela->getReferencia() <> $CI->Mfrmclass->uri_segmento($_SERVER['HTTP_REFERER'],4)){
//       if(isset($_SERVER['HTTP_REFERER']))
//         $CI->centinela->putReferencia($CI->Mfrmclass->uri_segmento($_SERVER['HTTP_REFERER'],4));
//       else
//         $CI->centinela->putReferencia('');
//       $CI->centinela->putcampo1('');
//       $CI->centinela->putcampo2('');
//       $CI->centinela->putcampo3('');
//      }
