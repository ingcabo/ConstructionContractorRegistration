...
class Con_consult_solv extends Controller
{
...
//      }
      ...
      $this->Mfrmclass->nombre_tabla    = 'consolvencia';
      $this->titulo                     = 'Vista de Contratistas Registradas';
      $this->encabezado                 = 'Listado de Contratistas Registradas';
      ...
      if($buscar_campo <> '0' and $buscar_filtro <> '' and $buscar_operador <> '0'){
        if($registro_offset == 0){
          ...
          $this->campos_lv = ($resultado_busqueda <> NULL) ? $resultado_busqueda->result_array() : NULL;
          $this->TotalRegistros       = $this->Mfrmclass->CantidadRegistros('vis_');
      }
      //
      ////http://idyt38/regco/index.php/Con_consult_solv
      //Parametros para paginacion
      $pag_config['base_url']   = base_url().'/index.php/Con_consult_solv/index/';
      ...
      if ($this->campos_lv != null){
        ...
        $this->load->view('seguimiento/vis_consulta_solv',$template);
      }else{
        $this->centinela->putcampo1('');
        $this->centinela->putcampo2('');
        $this->centinela->putcampo3('');
