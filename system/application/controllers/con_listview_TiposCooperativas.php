 ...
 * @author rcamejo
 */
class Con_listview_tiposcooperativas extends Controller{

    function Con_listview_tiposcooperativas(){
      parent::Controller();
      $col_anc = array('1'=>85,'2'=>10);
      $params = array('tabla_prefijo' => 'tpc_', 'tabla_nombre' => 'tipo_cooperativa', 'paginacion' => '5','anchos'=>$col_anc);
