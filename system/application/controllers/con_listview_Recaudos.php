 ...
 * @author rcamejo
 */
class Con_listview_recaudos extends Controller{

    function Con_listview_recaudos(){
      parent::Controller();
      $col_anc = array('1'=>65,'2'=>15,'3'=>15);
      $params = array('tabla_prefijo' => 'svr_', 'tabla_nombre' => 'solvencias_recaudos', 'paginacion' => '5','anchos'=>$col_anc);
