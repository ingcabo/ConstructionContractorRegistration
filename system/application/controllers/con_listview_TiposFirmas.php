 ...
 * @author rcamejo
 */
class Con_listview_tiposfirmas extends Controller{

    function Con_listview_tiposfirmas(){
      parent::Controller();
      $col_anc = array('1'=>85,'2'=>10);
      $params = array('tabla_prefijo' => 'tpf_', 'tabla_nombre' => 'tipo_firma', 'paginacion' => '5','anchos'=>$col_anc);
