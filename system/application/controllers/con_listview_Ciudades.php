 ...
 * @author rcamejo
 */
class Con_listview_ciudades extends Controller{

    function Con_listview_ciudades(){
      parent::Controller();
      $col_anc = array('1'=>65,'2'=>15,'3'=>15);
      $params = array('tabla_prefijo' => 'ciu_', 'tabla_nombre' => 'ciudades', 'paginacion' => '5','anchos'=>$col_anc);
