 ...
 * @author rcamejo
 */
class Con_listview_indice extends Controller{

    function Con_listview_indice(){
      parent::Controller();
      $params = array('tabla_prefijo' => 'ics_', 'tabla_nombre' => 'indice_capital_social', 'paginacion' => '5');
