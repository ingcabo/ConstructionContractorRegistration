...
class Usuarios extends Controller 
{
	...
	*/
	function index()
	{
		...
		$datos['query'] = $this->db->get('sistema.usuarios');
	...
	function registrar()
	{
		...
		{
			$this->db->query("INSERT INTO sistema.usuarios (usr_nick, usr_clave, usr_email, usr_nivel) VALUES (?,?,?,'1')", array($_POST['nick'], sha1($_POST['clave']), $_POST['mail']));
