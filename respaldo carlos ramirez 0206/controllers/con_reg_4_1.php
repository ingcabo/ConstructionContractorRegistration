...
function grabar(){
    ...
    {           // inicio de la recoleccion de datos de variables por post
               if(isset($_POST['nomb'])){
                ...
                $data['apdo']          ='Valor que debe venir de consulta y post';}

                if(isset($_POST['ced'])){
                $data['ced']           =$_POST['ced'];}else{
                $data['ced']           ='Valor que debe venir de consulta y post';}

                if(isset($_POST['nrif'])){
                $data['nrif']          =$_POST['nrif'];}else{
                $data['nrif']          ='Valor que debe venir de consulta y post';}

                if(isset($_POST['email'])){
                $data['email']         =$_POST['email'];}else{
                $data['email']         ='Valor que debe venir de consulta y post';}
