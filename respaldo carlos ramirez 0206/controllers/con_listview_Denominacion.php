 ...
 * @author rcamejo
 */
class Con_listview_denominacion extends Controller{

    function Con_listview_denominacion(){
      parent::Controller();
      $col_anc = array('1'=>65,'2'=>15,'3'=>15);
      $params = array('tabla_prefijo' => 'dec_', 'tabla_nombre' => 'denominacion_comercial', 'paginacion' => '5','anchos'=>$col_anc);
