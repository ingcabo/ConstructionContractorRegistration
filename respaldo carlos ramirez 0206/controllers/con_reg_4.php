...
function modificar($data){
     ...
     function alertacedula($persona,$ced_persona,$pk_contratista,$modo){
              ...
              if ($data['consulta_persona_en_contratista']->num_rows() > 0){
                ...
                $valorAAsignar=anchor('con_reg_4_1/grabar/'.$pk_contratista.'/'.$ced_persona.'/'.$modo,'La persona Ya existe ¿desea Agregarla a esta Contratista?<img alt="Siguiente" src="'.base_url().'system/application/imagenes/taza.gif" border="0">');
