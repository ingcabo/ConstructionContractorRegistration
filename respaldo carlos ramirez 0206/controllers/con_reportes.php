...
class Con_reportes extends controller
{
  ...
  ORDER BY aob_inicial,eac_principal desc';
    ...
    function rep_inscripcion($contratista_pk){
        ...
        $datos = 'select con_numero_rif,con_nombre,tpf_descripcion, con_fecha_inscripcion,con_codigo_siez from contratistas, tipo_firma as tf where con_contratistas_pk = ? and tpf_tipo_firma_pk = tpf_tipo_firma_fk';
