 ...
 * @author rcamejo
 */
class Con_listview_municipios extends Controller{

    function Con_listview_municipios(){
      parent::Controller();
      $col_anc = array('1'=>65,'2'=>15,'3'=>15);
      $params = array('tabla_prefijo' => 'mun_', 'tabla_nombre' => 'municipio', 'paginacion' => '5','anchos'=>$col_anc);
