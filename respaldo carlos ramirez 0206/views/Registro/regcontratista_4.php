  ...
  <div class="headerbox">
	  ...
	  <table width="764">
        ...
        <tr>
          ...
          <td><input type="checkbox" name="acc"    <?php echo $dis; ?> onclick="habilitaselect(this.form)"  <?php if($acc === "t"){ echo $checked; }else{echo "";}    ?>    value="<?php echo $acc;?>"/>
            Accionista
            <input type="text" name="porc" id= "porc" value="<?php echo $porc; ?>" size="2"  maxlength="5" onkeyup="revisaCadena(this)" />
        <label>%</label>
          </td>
          <td>&nbsp;</td>
        </tr>
	...
	<?php	 }else{  
		 ...
		 &nbsp;&nbsp;&nbsp; 
	 	  ...
	 	  <input type="button" name="fin" value="Finalizar" onclick="enviar(6)" />
		</div>
		  </td>
      </tr>
	  <tr>
