...
<div class="headerbox"> 
	  ...
	  <table  width="465" style="text-align:left" class="">
        ...
        <tr> 
          ...
          <span class="fontnormal"><font color="#FF0000"> <?php echo form_error('sucu'); ?> </font></span></td>
        </tr>
        <tr> 
...
<table width="277" height="64">
        <tr><td width="205" height="10"></td><td width="60"></td>
        </tr>
        </tr>
      ...
      <tr>
		...
		<input type="button" name="accion" value="Siguiente" onclick="enviar(5,<?php echo $valorpk; ?>)" />
		...
		<?php } ?>	
		<input type="button" name="fin" value="Finalizar" onclick="enviar(7)" />
		</th>
      </tr>
    </table>
                    ...
                    while ($parametro <= $can_areas){
					       ...
					       if($area == true){ 
					            ...
					            echo "<td>".$area->csu_direccion."</td>";
				 		        ...
				 		        $consulta = $this->db->query('select * from vis_contratistas_sucursales_telefonos where csu_contratistas_sucursales_pk ='.$area->csu_contratistas_sucursales_pk.' and con_contratistas_fk='.$valorpk.' and tls_activo = true');
